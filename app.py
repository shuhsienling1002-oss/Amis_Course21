...
vocab_data = [
    ...
    {"amis": "Dangah", "chi": "鍋子", "icon": "🥘", "source": "User Fix"},
    ...
    {"amis": "Dawdaw", "chi": "燈", "icon": "💡", "source": "User Fix"},
    {"amis": "Tilifi", "chi": "電視", "icon": "📺", "source": "User Fix"},
]

# --- 句子庫 (7句: 源自 CSV 並移除連字號) ---
sentences = [
    {"amis": "Awa ko loma' noni a wawa.", "chi": "這個小孩沒有家。", "icon": "🏠", "source": "Row 328 (Cleaned)"},
    {"amis": "O sakaihacowa koya a kaysing?", "chi": "那個碗是要用在何時的？", "icon": "🥣", "source": "Row 589 (Cleaned)"},
    {"amis": "Pasicowaen koni a fawahan?", "chi": "這道門要朝向哪裡？", "icon": "🚪", "source": "Row 731 (Cleaned)"},
    {"amis": "O kalomaan ni Panay kora a impic?", "chi": "那支鉛筆是被Panay當成什麼？", "icon": "✏️", "source": "Row 742 (Cleaned)"},
    {"amis": "Maro' kamo i 'anengan.", "chi": "你們坐在椅子上。", "icon": "🪑", "source": "Row 1846 (Cleaned)"},
    {"amis": "O malotatakel kona sapad.", "chi": "這木板要做成床鋪。", "icon": "🛏️", "source": "Row 1176 (Cleaned)"},
    {"amis": "Ora a sasing ko aihacowaen.", "chi": "那張照片是要一直處在過去時刻的。", "icon": "🖼️", "source": "Row 651 (Cleaned)"},
]
...
raw_quiz_pool = [
    ...
    {
        "q": "O malotatakel kona sapad.",
        "audio": "O malotatakel kona sapad",
...
st.markdown("<p style='text-align: center; color: #666;'>家具與生活用品 (No Hyphens)</p>", unsafe_allow_html=True)
